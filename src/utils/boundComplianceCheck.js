...
export const checkIsWithinTopBound = index =>
    checkIsWithinBound(index + MISSILE_SIDE_IN_CELLS, CELLS_VERTICAL_COUNT);
...
export const checkIsWithinRightBound = index =>
    checkIsWithinBound(index + MISSILE_SIDE_IN_CELLS, CELLS_HORIZONTAL_COUNT);
